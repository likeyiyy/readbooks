    ...
    (function() {
        ...
        jQuery(function() {
            $.tags = function(element, options) {
                ...
                this.getRandTagClass || (this.getRandTagClass = function(tag) {
                    var btnType = [
                        'btn-primary',
                        'btn-success',
                        'btn-info',
                ...
                if (options.tagClassData) {
                    this.tagClassArray = options.tagClassArray;
                } else {
                    this.tagClassArray = [];
                    _ref = this.tagsArray;
                    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                        tag = _ref[_i];
                        this.tagClassArray.push(null);
                    }
                }
                ...
                this.getTagsClass = function() {
                    return _this.tagClassArray;
                };
                ...
                this.removeTag = function(tag) {
                    if (_this.tagsArray.indexOf(tag) > -1) {
                        ...
                        _this.tagClassArray.splice(_this.tagsArray.indexOf(tag), 1);
                ...
                this.addTag = function(tag) {
                    ...
                    if (_this.canAddByRestriction(tag) && !_this.hasTag(tag) && tag.length > 0 && _this.canAddByExclusion(tag) && _this.canAddByMaxNum()) {
                        ...
                        associatedTagClass = _this.getRandTagClass(tag);
                        _this.popoverArray.push(associatedContent || null);
                        _this.tagClassArray.push(associatedTagClass || null);
                ...
                this.formatTag = function(i, tag, isReadOnly) {
                    ...
                    return _this.template("tag", {
                        tag: escapedTag,
                        tagClass: _this.tagClassArray[i],
