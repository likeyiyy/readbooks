...
class InsertQuery(_WriteQuery):
    def __init__(self, model_class, field_dict=None, rows=None,
                 fields=None, query=None, validate_fields=False, upsert=False):
...
class Model(with_metaclass(BaseModel)):
    ...
    @classmethod
    def insert_many(cls, rows, validate_fields=True, upsert=True):
        return InsertQuery(cls, rows=rows, validate_fields=True, upsert=upsert)
